...
<section aria-labelledby="summary-heading" class="bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8 mt-8 sm:mt-2 2xl:mt-5 lg:col-span-5">
    <div class="flex items-center">
        ...
        <div class="ml-4">
            ...
            <x-wedo.secondary-button class="w-full" link target="_blank">
                <x-heroicon-o-external-link class="-ml-1 mr-2 h-5 w-5 text-{{ app_color() }}-400"/>
                <span>{{ __('https://gitlab.com/') }}</span>
