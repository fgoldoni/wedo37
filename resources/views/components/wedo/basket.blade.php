...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-0">
    <div>
        ...
        <div class="mt-2 md:flex md:items-center md:justify-between">
            ...
            @if($save)
                <div class="mt-4 flex-shrink-0 flex md:mt-0 md:ml-4">
                    <a href="javascript:;" wire:click="save" class="btn-base inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-{{ app_color() }}-600 hover:bg-{{ app_color() }}-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-{{ app_color() }}-500">
                        Continue
                    </a>
                </div>
            @endif
