        ...
        <section aria-labelledby="summary-heading" class="hidden w-full sticky top-0 max-w-md flex-col bg-gray-50 lg:flex">
            <div class="sticky bottom-0 flex-none border-t border-gray-200 bg-gray-50 p-6">
                ...
                <div class="border-t border-gray-200 py-6">
                    <button type="button" onclick="Livewire.emit('openModal', 'wedo.modals.popup.wedo')"    class="flex items-center justify-center w-full rounded-md border border-{{ app_color() }}-300 bg-white py-3 px-4 text-base font-medium text-{{ app_color() }}-900 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50">
