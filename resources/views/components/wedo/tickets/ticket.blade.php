                ...
                <div class="relative">
                    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="relative p-10 mt-10 bg-white rounded-lg shadow-xl md:mt-0">
                            ...
                            <a href="{{ route('checkout.index') }}" class="hover:scale-105 hover:shadow-2xl ease-in-out duration-150 flex items-center justify-center w-full px-6 py-3 my-8 text-lg text-white bg-{{ $ticket->color }}-600 rounded-md hover:bg-{{ $ticket->color }}-700 sm:w-auto">
                                {{ __('Continue') }}
