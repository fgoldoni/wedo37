    ...
    <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <a href="{{ route('tickets.index', ['filters' => $filters]) }}" class="uppercase inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200 mb-7">
                ...
                <span class="ml-4 text-sm sm:hidden">{{ app_event()?->start_mobile }}</span>
                <span class="ml-4 text-sm hidden sm:block">{{ app_event()?->start }}</span>
            ...
            <div class="uppercase flex flex-col items-center pt-2 sm:flex-row sm:pt-4 space-x-6  mb-5">
