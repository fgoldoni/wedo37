<footer {{ $attributes->merge(['class' => 'bg-gray-900']) }} aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div class="col-span-1 xl:col-span-4">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-base font-medium text-white">{{ __('Informations') }}</h3>
                        <ul role="list" class="mt-4 space-y-4">
                            <li>
                                <a href="javascript:;" class="text-base text-gray-300 hover:text-white">{{ __('UPDATE-SEITE-COVID-19') }}</a>
                            </li>

                            <li>
                                <a href="javascript:;" class="text-base text-gray-300 hover:text-white">{{ __('À propos') }}</a>
                            </li>

                            <li>
                                <a href="{{ route('contact') }}" class="text-base text-gray-300 hover:text-white">{{ __('Questions les plus fréquentes (F.A.Q )') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="mt-12 md:mt-0">
                        <h3 class="text-base font-medium text-white">{{ __('Mentions légales') }}</h3>
                        @livewire('wedo.home.footer')
                    </div>
                </div>
            </div>
            <div class="mt-12 xl:mt-0">
                <h3 class="text-base font-medium text-white">Language</h3>
        ...
        <div class="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
            <div>
                <h3 class="text-base font-medium text-white">S'abonner à notre newsletter</h3>
                <p class="mt-2 text-base text-gray-300">{{ __('pages/home.footer.copyright', ['team' => app_team_name()]) }}</p>
            </div>
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            <div class="flex space-x-6 md:order-2">
                @if(app_team()->facebook)
                    <a href="{{ app_team()->facebook }}" target="_blank"  class="text-gray-400 hover:text-gray-300">
                ...
                @if(app_team()->instagram)
                    <a href="{{ app_team()->instagram }}" class="text-gray-400 hover:text-gray-300">
                ...
                @if(app_team()->twitter)
                    <a href="{{ app_team()->twitter }}" class="text-gray-400 hover:text-gray-300">
                ...
                @if(app_team()->youtube)
                    <a href="{{ app_team()->youtube }}" class="text-gray-400 hover:text-gray-300">
                        <span class="sr-only">Youtube</span>
                        <svg class="h-6 w-6 fill-current" viewBox="0 0 80 56" xmlns="http://www.w3.org/2000/svg"><path d="m41.771 55.637-16.395-.3c-5.308-.104-10.63.104-15.834-.978-7.916-1.618-8.477-9.548-9.064-16.2-.809-9.35-.496-18.872 1.03-28.145.862-5.204 4.252-8.309 9.495-8.647C28.703.141 46.52.287 64.18.86c1.865.052 3.743.339 5.582.665 9.078 1.591 9.299 10.578 9.888 18.143.586 7.642.339 15.325-.783 22.915-.9 6.285-2.622 11.556-9.888 12.065-9.104.665-18 1.2-27.129 1.03 0-.04-.052-.04-.078-.04Zm-9.638-15.912c6.86-3.94 13.59-7.813 20.411-11.725-6.873-3.94-13.59-7.813-20.411-11.726v23.451Z" fill-rule="nonzero"></path></svg>
                    </a>
                @endif
            </div>
            <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0"> {{ __('pages/home.footer.description') }}</p>
        </div>
    </div>
</footer>
