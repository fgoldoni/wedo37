...
{{--                            </li>--}}
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-base font-medium text-gray-900">{{ __('Mentions légales') }}</h3>
        ...
        <div class="mt-8 border-t border-gray-300 pt-8 md:flex md:items-center md:justify-between">
            <div class="flex space-x-6 md:order-2">
                ...
                @if(app_team()->instagram)
                    <a href="{{ app_team()->instagram }}" class="text-gray-400 hover:text-gray-500">
                ...
                @if(app_team()?->twitter)
                    <a href="{{ app_team()?->twitter }}" class="text-gray-400 hover:text-gray-500">
                ...
                @if(app_team()->youtube)
                    <a href="{{ app_team()->youtube }}" class="text-gray-400 hover:text-gray-500">
