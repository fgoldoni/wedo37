<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    @if($total === 0)
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="flex items-center w-full lg:w-1/2 lg:pr-10">
                    <div class="relative max-w-lg mx-auto font-sans text-center text-gray-700 border-gray-200 lg:text-left">
                        <h1 class="m-0 text-3xl font-extrabold leading-tight text-left text-{{ app_color() }}-900 border-solid sm:text-4xl md:text-6xl">
                            Specify & search your job
                        </h1>
                        <p class="pr-5 mx-0 my-4 text-base text-left text-gray-500 xl:leading-9 lg:my-8 xl:text-xl">
                            Use the {{ app_team()->display_name }} platform to chat, share files, and collaborate from your desktop or on the go.
                        </p>
                        <div class="relative flex items-start justify-start block w-full max-w-md text-center lg:mx-0">
                            <a href="{{ route('jobs.index') }}" class="flex items-center justify-center px-8 font-medium text-white bg-{{ app_color() }}-500 rounded-full h-14">Get Started Today</a>
                        </div>
        ...
        <x-wedo.learn-more name="applications" link="#" ></x-wedo.learn-more>
