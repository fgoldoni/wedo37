            ...
            <div class="lg:col-span-2">
                <div class="grid grid-cols-1">
                    <section class="relative w-full">
                        ...
                        <x-wedo.disclosure title="Secure payment" open>
                            <x-wedo.button  wire:click="save" wire:loading.attr="disabled" id="checkout-button" class="relative w-full py-4 items-center">
                            ...
                            <x-wedo.divider label="Or with Paypal" class="py-8"></x-wedo.divider>
