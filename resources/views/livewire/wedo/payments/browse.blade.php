                    ...
                    <section class="relative w-full">
                        ...
                        <x-wedo.disclosure title="{{ __('Secure payment') }}" open>
                            ...
                            <div class="flex items-center justify-center pt-4 relative cursor-pointer" wire:click="sofort">
                                <x-wedo.loader wire:loading wire:target="sofort"></x-wedo.loader>
                                <img class="h-16 bg-white rounded shadow-md px-6 py-4 border btn-base" src="{{ asset('images/svg/sofort.svg') }}" alt="sofort">
                            </div>
