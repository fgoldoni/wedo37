<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <!-- Profile -->
    <x-wedo.jobs.profile :phone="app_event()->phone" :item="$row"></x-wedo.jobs.profile>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <div class="relative scrollbar-thin scrollbar-thumb-secondary-400 scrollbar-track-secondary-200 overflow-y-auto max-height">
                                            <ul class="grid grid-cols-1 space-y-4">
                                                @livewire('wedo.tickets.item', ['item' => json_encode($row), 'first' => true], key('wedo.tickets.item-' . $row->id))
                                            </ul>
                                        </div>
